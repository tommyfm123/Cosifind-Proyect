...
export default function ProductsSection({ products, onShowAllProducts }: ProductsSectionProps) {
    ...
    return (
        <div className="px-2 py-10 bg-white sm:px-4 sm:py-16 md:px-8 md:py-20 lg:px-16 lg:py-24">
            ...
            >
                {products.map((product) => (
                    <SwiperSlide key={product.id} className="flex h-auto">
                        <div className="relative flex flex-col w-full h-full overflow-hidden rounded-xl border border-gray-200 shadow-md">
                            <div className="relative flex h-60 sm:h-72 md:h-80 overflow-hidden rounded-t-xl">
                                <img
                            ...
                            <div className="px-5 py-4">
                                <h5 className="text-base font-semibold text-slate-900 sm:text-lg md:text-xl">
                                    {product.name}
                                </h5>
